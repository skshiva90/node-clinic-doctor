...
load.data = function (name, has.issue) {
  gc=read.csv(paste0('data/', name, '.clinic-doctor/', name, '.clinic-doctor-traceevent.csv'), strip.white=T)
  ...
  stat=read.csv(paste0('data/', name, '.clinic-doctor/', name, '.clinic-doctor-processstat.csv'), strip.white=T)

  system = read_json(paste0('data/', name, '.clinic-doctor/', name, '.clinic-doctor-systeminfo'))
